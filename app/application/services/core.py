...
class PluginService:
    ...
    async def enable(self, plugin_id: str) -> dict[str, Any]:
        ...
        self._state_repository.save_state(
            ...
            command_id=None,
            events=[DomainEvent(event_type="plugin_enabled", payload={"plugin_id": normalized_plugin_id})],
        )
    ...
    async def disable(self, plugin_id: str) -> dict[str, Any]:
        ...
        self._state_repository.save_state(
            ...
            command_id=None,
            events=[DomainEvent(event_type="plugin_disabled", payload={"plugin_id": normalized_plugin_id})],
        )
        return self._find_plugin(normalized_plugin_id)
